...
<footer class="bg-slate-900 text-white pt-20 pb-10">
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
        <div class="col-span-1 md:col-span-1 lg:col-span-1">
            <a href="http://127.0.0.1:8002/" class="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            <ul class="space-y-3 text-sm">
                <li><a href="http://127.0.0.1:8002/" class="hover:text-white transition-colors">Home</a></li>
                <li><a href="http://127.0.0.1:8002/about" class="hover:text-white transition-colors">About Us</a></li>
                <li><a href="http://127.0.0.1:8002/campaigns" class="hover:text-white transition-colors">Campaigns</a></li>
                <li><a href="http://127.0.0.1:8002/impact" class="hover:text-white transition-colors">Our Impact</a></li>
                <li><a href="http://127.0.0.1:8002/get-involved" class="hover:text-white transition-colors">Volunteer</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-3 text-sm">
                <li><a href="http://127.0.0.1:8002/donate" class="hover:text-white transition-colors">Make a Donation</a></li>
                <li><a href="http://127.0.0.1:8002/get-involved" class="hover:text-white transition-colors">Volunteer Programs</a></li>
                <li><a href="http://127.0.0.1:8002/campaigns" class="hover:text-white transition-colors">Current Campaigns</a></li>
                <li><a href="http://127.0.0.1:8002/contact" class="hover:text-white transition-colors">Contact Us</a></li>
            </ul>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6 pt-10 border-t border-slate-800">
        <div class="flex flex-col items-center text-center gap-8">
            <div class="flex flex-wrap items-center justify-center gap-y-2 gap-x-6 text-[11px] font-bold uppercase tracking-wider text-slate-500">
                <a href="http://127.0.0.1:8002/terms" class="hover:text-emerald-500 transition-colors">Terms & Conditions</a>
                <a href="http://127.0.0.1:8002/privacy" class="hover:text-emerald-500 transition-colors">Privacy Policy</a>
                <a href="http://127.0.0.1:8002/faq" class="hover:text-emerald-500 transition-colors">FAQ</a>
            </div>
