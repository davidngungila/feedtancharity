                ...
                <div class="mega-menu absolute top-full left-1/2 transform -translate-x-1/2 w-screen max-w-4xl bg-white rounded-2xl shadow-2xl border border-slate-100 mt-2 p-8">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            ...
                            <ul class="space-y-3">
                                <li><a href="/campaigns" class="text-slate-600 hover:text-emerald-600 transition-colors">Daily Meal Programs</a></li>
                                <li><a href="/campaigns" class="text-slate-600 hover:text-emerald-600 transition-colors">Weekend Backpacks</a></li>
                                <li><a href="/campaigns" class="text-slate-600 hover:text-emerald-600 transition-colors">Summer Feeding</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                <li><a href="/campaigns" class="text-slate-600 hover:text-emerald-600 transition-colors">Disaster Response</a></li>
                                <li><a href="/campaigns" class="text-slate-600 hover:text-emerald-600 transition-colors">Food Distribution</a></li>
                                <li><a href="/campaigns" class="text-slate-600 hover:text-emerald-600 transition-colors">Emergency Supplies</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                <li><a href="/campaigns" class="text-slate-600 hover:text-emerald-600 transition-colors">Urban Gardens</a></li>
                                <li><a href="/campaigns" class="text-slate-600 hover:text-emerald-600 transition-colors">School Gardens</a></li>
                                <li><a href="/campaigns" class="text-slate-600 hover:text-emerald-600 transition-colors">Community Workshops</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 pt-8 border-t border-slate-100">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="/campaigns" class="px-6 py-3 bg-emerald-600 text-white rounded-full font-semibold hover:bg-emerald-700 transition-colors">
            ...
            <nav class="space-y-2">
                ...
                <div class="py-4">
                    ...
                    <ul class="space-y-3 ml-4">
                        <li><a href="/campaigns" class="flex items-center gap-4 group/item p-3 rounded-2xl hover:bg-emerald-50 transition-all">
