    ...
    <div class="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between">
        ...
        <div class="hidden lg:flex items-center gap-10">
            ...
            <div class="relative group py-8">
                <a href="{{ url('/campaigns') }}" class="nav-link font-bold hover:text-emerald-600 transition-colors flex items-center gap-1">
    ...
    <div class="absolute right-0 top-0 h-full w-80 max-w-full bg-white shadow-2xl overflow-y-auto">
        <div class="p-6">
            ...
            <div class="mt-8 pt-8 border-t border-slate-200">
                <a href="{{ url('/donate') }}" class="w-full inline-block py-4 bg-emerald-500 text-white font-black text-xs uppercase tracking-widest text-center rounded-2xl shadow-xl shadow-emerald-500/20">Donate Now</a>
            </div>
        </div>
    </div>
</div>
