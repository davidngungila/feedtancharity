                        ...
                        <div class="swiper-slide relative flex items-center">
                            ...
                            <div class="relative z-10 max-w-7xl mx-auto px-6 w-full">
                                <div class="max-w-2xl translate-y-10 opacity-0 transition-all duration-1000 slide-content">
                                    ...
                                    <div class="flex flex-col sm:flex-row items-center gap-4">
                                        <a href="{{ url('campaigns') }}" class="w-full sm:w-auto px-10 py-4 bg-emerald-600 text-white font-bold rounded-full hover:bg-emerald-700 shadow-xl shadow-emerald-600/30 transition-all text-center">Support Gardens</a>
                                        <a href="{{ url('get-involved') }}" class="w-full sm:w-auto px-10 py-4 bg-white/10 text-white font-bold rounded-full border border-white/20 hover:bg-white/20 transition-all text-center backdrop-blur-md">Learn More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="relative z-10 max-w-7xl mx-auto px-6 w-full">
                                <div class="max-w-2xl translate-y-10 opacity-0 transition-all duration-1000 slide-content">
                                    ...
                                    <div class="flex flex-col sm:flex-row items-center gap-4">
                                        ...
                                        <a href="{{ url('about') }}" class="w-full sm:w-auto px-10 py-4 bg-white/10 text-white font-bold rounded-full border border-white/20 hover:bg-white/20 transition-all text-center backdrop-blur-md">About Us</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="rounded-[2.5rem] border border-slate-100 bg-white shadow-sm overflow-hidden">
                                <div class="p-10">
                                    ...
                                    <div class="mt-10 grid gap-3 sm:grid-cols-2">
                                        <a href="{{ url('campaigns') }}" class="rounded-2xl border border-slate-200 bg-white px-6 py-4 text-center text-sm font-bold text-slate-900 hover:bg-slate-50">Support Campaigns</a>
                                        <a href="{{ url('get-involved') }}" class="rounded-2xl bg-emerald-600 px-6 py-4 text-center text-sm font-bold text-white hover:bg-emerald-700">Volunteer With Us</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="py-32 bg-slate-50" id="campaigns">
                <div class="max-w-7xl mx-auto px-6">
                    <div class="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
                        ...
                        <a href="{{ url('campaigns') }}" class="text-emerald-600 font-bold flex items-center gap-2 hover:gap-3 transition-all">View All Campaigns <i class="ph ph-arrow-right"></i></a>
                    </div>
                    ...
                    <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                        <div class="bg-white rounded-3xl shadow-lg overflow-hidden border border-slate-100">
                            ...
                            <div class="p-8">
                                ...
                                <a href="{{ url('campaigns') }}" class="w-full bg-emerald-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-emerald-700 transition-all text-center">
            ...
            <section class="py-24 bg-emerald-600">
                <div class="max-w-7xl mx-auto px-6 text-center">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-6">
                        <a href="{{ url('campaigns') }}" class="px-12 py-5 bg-white text-emerald-600 font-bold rounded-full shadow-2xl hover:scale-105 transition-all">Donate Now</a>
                        <a href="{{ url('about') }}" class="flex items-center gap-3 text-white font-bold hover:scale-105 transition-all text-xl">
